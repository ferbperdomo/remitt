                                            ...
                                            <div className="container py-5 lg:py-10 mx-auto flex">
                                                ...
                                                <div className=" bg-white rounded-lg p-8 flex flex-col md:flex-row w-full mt-10 md:mt-0 relative z-10 shadow-md">
                                                    <div className="xl:w-1/3 md:w-1/2 p-4" key={provider.id}>
                                                        <div className="w-40 md:w-1/2 h-10 py-2.5 px-5 inline-flex items-center justify-center text-white bg-gradient-to-br from-purple-300 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm  text-center">
                                                    ...
                                                    <div>
                                                        <button type="button" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center flex">
                                                            Ir a {provider.name}
