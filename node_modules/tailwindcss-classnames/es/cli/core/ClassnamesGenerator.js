...
var ClassnamesGenerator = /** @class */ (function () {
    ...
    function ClassnamesGenerator(parser) {
        ...
        this.layout = function () {
            return __assign(__assign({}, nonConfigurableClassNames.layout), { objectPosition: Object.keys(_this._theme.objectPosition).map(function (x) { return 'object-' + x; }), inset: Object.keys(_this._theme.inset).flatMap(function (insetValue) {
        ...
        this.backgrounds = function () {
            return __assign(__assign({}, nonConfigurableClassNames.backgrounds), { backgroundOpacity: _this.getGeneratedClassesWithOpacities().backgroundOpacities, backgroundColor: _this.generateClassesWithColors('backgroundColor'), backgroundPosition: Object.keys(_this._theme.backgroundPosition).map(function (x) { return 'bg-' + x; }), backgroundSize: Object.keys(_this._theme.backgroundSize).map(function (x) { return 'bg-' + x; }), backgroundImage: Object.keys(_this._theme.backgroundImage).map(function (x) { return 'bg-' + x; }), gradientColorStops: _this.generateClassesWithColors('gradientColorStops').flatMap(function (val) {
                    return ['from', 'via', 'to'].map(function (x) { return x + val.replace('gradient', ''); });
                }) });
        };
        this.borders = function () {
            return __assign(__assign({}, nonConfigurableClassNames.borders), { 
                ...
                divideWidth: Object.keys(_.isEmpty(_this._theme.divideWidth) ? _this._theme.borderWidth : _this._theme.divideWidth)
                    .concat('reverse')
                ...
                ringColor: _this.generateClassesWithColors('ringColor'), ringWidth: Object.keys(_this._theme.ringWidth)
                    ...
                    .concat('ring-inset'), ringOpacity: _this.getGeneratedClassesWithOpacities().ringOpacities, ringOffsetColor: _this.generateClassesWithColors('ringOffsetColor'), ringOffsetWidth: Object.keys(_this._theme.ringOffsetWidth).map(function (x) { return 'ring-offset-' + x; }), outlineOffset: Object.keys(_this._theme.outlineOffset).map(function (x) { return 'outline-' + x; }), outlineWidth: Object.keys(_this._theme.outlineWidth).map(function (x) { return 'outline-' + x; }), outlineColor: _this.generateClassesWithColors('outlineColor') });
        };
        this.tables = function () {
            return nonConfigurableClassNames.tables;
        };
        this.effects = function () {
            return __assign(__assign({}, nonConfigurableClassNames.effects), { boxShadow: Object.keys(_this._theme.boxShadow).map(function (key) { return "shadow-" + key; }), boxShadowColor: _this.generateClassesWithColors('boxShadowColor'), opacity: _this.getGeneratedClassesWithOpacities().opacities });
        };
        this.transitionsAndAnimations = function () {
            return __assign(__assign({}, nonConfigurableClassNames.transitionsAndAnimations), { transitionProperty: Object.keys(_this._theme.transitionProperty).map(function (property) { return 'transition-' + property; }), transitionDuration: Object.keys(_this._theme.transitionDuration).map(function (value) { return 'duration-' + value; }), transitionTimingFunction: Object.keys(_this._theme.transitionTimingFunction)
        ...
        this.transforms = function () {
            return __assign(__assign({}, nonConfigurableClassNames.transforms), { scale: ['', 'x-', 'y-'].flatMap(function (x) {
                ...
                translate: ['x', 'y'].flatMap(function (side) {
                    return Object.keys(_.isEmpty(_this._theme.translate) ? _this._theme.spacing : _this._theme.translate).map(function (value) {
        ...
        this.SVG = function () {
            return __assign(__assign({}, nonConfigurableClassNames.svg), { fill: Object.keys(_this._theme.fill).map(function (value) { return 'fill-' + value; }), stroke: Object.keys(_this._theme.stroke).map(function (value) { return 'stroke-' + value; }), strokeWidth: Object.keys(_this._theme.strokeWidth).map(function (value) { return 'stroke-' + value; }) });
        };
        this.accessibility = function () {
            return __assign({}, nonConfigurableClassNames.accessibility);
        };
        this.filters = function () {
            return __assign(__assign({}, nonConfigurableClassNames.filters), { blur: Object.keys(_this._theme.blur).map(function (x) { return 'blur-' + x; }), brightness: Object.keys(_this._theme.brightness).map(function (x) { return 'brightness-' + x; }), contrast: Object.keys(_this._theme.contrast).map(function (x) { return 'contrast-' + x; }), dropShadow: Object.keys(_this._theme.dropShadow).map(function (x) { return 'drop-shadow-' + x; }), grayscale: Object.keys(_this._theme.grayscale).map(function (x) { return 'grayscale-' + x; }), hueRotate: Object.keys(_this._theme.hueRotate).map(function (x) {
        ...
        this.spacing = function () {
            ...
            return {
                padding: sides.flatMap(function (side) {
                    return Object.keys(_.isEmpty(_this._theme.padding) ? _this._theme.spacing : _this._theme.padding).map(function (value) {
                        return value.startsWith('-') ? "-p" + side + "-" + value.slice(1) : "p" + side + "-" + value;
                    });
                }),
                margin: sides.flatMap(function (side) {
                    return Object.keys(_.isEmpty(_this._theme.margin) ? _this._theme.spacing : _this._theme.margin).map(function (value) {
                        return value.startsWith('-') ? "-m" + side + "-" + value.slice(1) : "m" + side + "-" + value;
                    });
                }),
                space: ['x', 'y'].flatMap(function (axis) {
                    return Object.keys(_.isEmpty(_this._theme.space) ? _this._theme.spacing : _this._theme.space)
                        .concat('reverse')
                        .map(function (key) {
                        if (key.startsWith('-')) {
                            key = key.slice(1);
        ...
        this.sizing = function () {
            ...
            return __assign(__assign({}, nonConfigurableClassNames.sizing), { 
                ...
                // prettier-ignore
                height: (_.isEmpty(_this._theme.height)
        ...
        this.pseudoClasses = function () {
            ...
            var _loop_1 = function (regularClassGroupKey) {
                Object.keys(_this._generatedRegularClassnames).map(function (key) {
                    ...
                    if (_.has(_this._generatedRegularClassnames[key], regularClassGroupKey)) {
                        // Get the value of the found generated class group
                        var generatedClassGroup = _.get(_this._generatedRegularClassnames, key + "." + regularClassGroupKey);
            ...
            for (var _i = 0, regularClassGroupKeys_1 = regularClassGroupKeys; _i < regularClassGroupKeys_1.length; _i++) {
                var regularClassGroupKey = regularClassGroupKeys_1[_i];
        ...
        this.getGeneratedClassesWithOpacities = function () {
            ...
            function generateOpacities(defaultOpacities, theme, property) {
                var _a;
                var themeOpacities = _.isEmpty(theme[property]) ? defaultOpacities : theme[property];
                var extendedThemeOpacities = (_a = theme.extend) === null || _a === void 0 ? void 0 : _a[property];
                var result = extendedThemeOpacities
                    ? __assign(__assign({}, themeOpacities), extendedThemeOpacities) : themeOpacities;
                return result;
            }
            return {
        ...
        if (configPlugins !== null) {
            ...
            var pluginCustomForms = tailwindLabsPlugins.pluginCustomForms, pluginTypography = tailwindLabsPlugins.pluginTypography;
